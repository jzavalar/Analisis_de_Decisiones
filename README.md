...
0.1. Presentación del programa
0.2. Evaluación Global y de Recuperación
0.3. Programa oficial vigente de la UEA ([pdf](http://csh.izt.uam.mx/sistemadivisional/SDIP/pac/2211092pe.pdf)) y Programa oficial vigente de la UEA prerrequisito: [Estadística I](http://csh.izt.uam.mx/sistemadivisional/SDIP/pac/2132044pe.pdf)
0.4. Acceso a nueva plataforma de [Virtuami](http://virtuami.izt.uam.mx/aulas/apresencial2)
0.5. Prácticas:
